...
type Envelope struct {
	...
	Type          string                 `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`                                        // e.g. "match.result", "presence.changed"
	Source        string                 `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty"`                                    // producing layer: match | main | gateway | login | worker
	CorrelationId string                 `protobuf:"bytes,3,opt,name=correlation_id,json=correlationId,proto3" json:"correlation_id,omitempty"` // trace id; for settlement, also the idempotency assist
	TsUnixMs      int64                  `protobuf:"varint,4,opt,name=ts_unix_ms,json=tsUnixMs,proto3" json:"ts_unix_ms,omitempty"`             // producer wall clock (millis)
	Payload       []byte                 `protobuf:"bytes,5,opt,name=payload,proto3" json:"payload,omitempty"`                                  // the event's own protobuf message (see events.proto)
...
func (x *Envelope) GetTsUnixMs() int64 {
	if x != nil {
		return x.TsUnixMs
	}
	return 0
...
const file_envelope_proto_rawDesc = "" +
	"\n" +
	"\x0eenvelope.proto\x12\x03bus\"\x95\x01\n" +
	"\bEnvelope\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12%\n" +
	"\x0ecorrelation_id\x18\x03 \x01(\tR\rcorrelationId\x12\x1c\n" +
	"\n" +
	"ts_unix_ms\x18\x04 \x01(\x03R\btsUnixMs\x12\x18\n" +
	"\apayload\x18\x05 \x01(\fR\apayloadB\"Z libmadoka/match-server/bus/pb;pbb\x06proto3"
